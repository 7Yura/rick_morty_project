...
import {ICharacter, IEpisode, IPagination} from "../interfaces";
...
export class EpisodeService {
  ...
  getAll(page: number = 1): Observable<IPagination<IEpisode>> {
    return this.httpClient.get<IPagination<IEpisode>>(urls.episode, {params: {page}})/*.pipe(delay(2000))*/;
  }
